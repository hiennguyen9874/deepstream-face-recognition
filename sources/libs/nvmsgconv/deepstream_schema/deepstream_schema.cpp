...
static bool nvds_msg2p_parse_place_yaml(void *privData, gchar *cfg_file_path, std::string group_str)
{
    bool ret = false;
    bool isEnabled = false;
    NvDsPayloadPriv *privObj = NULL;
...
static bool nvds_msg2p_parse_analytics_yaml(void *privData,
                                            gchar *cfg_file_path,
                                            std::string group_str)
{
    bool ret = false;
