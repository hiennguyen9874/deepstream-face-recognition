...
public:
     ...
     */
    Array() : ArrayBase{0, sizeof(T), nullptr, true} {}
     ...
     * @param isCPU whether to allocate array on CPU or GPU.
     */
    Array(std::size_t capacity, bool isCPU = true) : ArrayBase{capacity, sizeof(T), isCPU} {}
     ...
     */
    Array(Array &&t) : Array() { *this = std::move(t); }
...
public:
     ...
     */
    ArrayN() : ArrayBase{N, sizeof(T), true} { setSize(N); }
     ...
     * @param isCPU whether to allocate array on CPU or GPU.
     */
    ArrayN(bool isCPU) : ArrayBase{N, sizeof(T), isCPU} { setSize(N); }
     ...
     */
    ArrayN(ArrayN &&t) : ArrayN() { *this = std::move(t); }
