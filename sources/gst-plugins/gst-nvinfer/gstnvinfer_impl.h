...
class DsNvInferImpl {
public:
    using ContextReplacementPtr = std::unique_ptr<
        std::tuple<NvDsInferContextPtr, NvDsInferContextInitParamsPtr, std::string>>;
...
private:
    ...
    bool isNewContextValid(INvDsInferContext &newCtx, NvDsInferContextInitParams &newParam);
