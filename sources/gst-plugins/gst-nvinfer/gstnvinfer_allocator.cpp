...
G_DEFINE_TYPE_WITH_CODE(GstNvInferAllocator, gst_nvinfer_allocator, GST_TYPE_ALLOCATOR, _do_init);
...
static void gst_nvinfer_allocator_free(GstAllocator *allocator, GstMemory *memory)
{
...
static gpointer gst_nvinfer_memory_map(GstMemory *mem, gsize maxsize, GstMapFlags flags)
{
